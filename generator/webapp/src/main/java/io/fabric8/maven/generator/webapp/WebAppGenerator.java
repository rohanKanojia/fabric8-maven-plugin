...
public class WebAppGenerator extends BaseGenerator {
    ...
    public List<ImageConfiguration> customize(List<ImageConfiguration> configs, boolean prePackagePhase) {
        if(MavenUtil.hasAutoGeneratedFinalName(getProject())) {
            log.error("No ${project.build.finalName} found in in project");
            throw new IllegalArgumentException("WebAppGenerator requires <finalName> to be set in <build>");
        }
