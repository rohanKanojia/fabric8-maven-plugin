...
public class MavenUtil {
    ...
    public static boolean hasAutoGeneratedFinalName(MavenProject project) {
        return project.getModel().getBuild().getFinalName().equals(project.getArtifactId() + "-" + project.getVersion());
    }
